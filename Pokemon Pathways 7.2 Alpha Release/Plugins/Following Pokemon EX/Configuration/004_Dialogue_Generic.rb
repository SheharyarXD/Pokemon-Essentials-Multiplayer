...
Events.OnTalkToFollower += proc { |_pkmn, _random_val|
  items = [
    :HYPERPOTION,   :SUPERPOTION,  :FULLRESTORE,    :REVIVE,        :PPUP,
    :PPMAX,         :RARECANDY,    :REPEL,          :MAXREPEL,      :BIGPEARL,
    :HONEY,         :TINYMUSHROOM, :PEARL,          :NUGGET,        :GREATBALL,
    :ULTRABALL,     :THUNDERSTONE, :MOONSTONE,      :SUNSTONE,      :DUSKSTONE,
    :DAWNSTONE,     :SHINYSTONE,   :FIRESTONE,      :LEAFSTONE,     :WATERSTONE,
    :BIGMUSHROOM,   :MAXREVIVE
  ]
...
Events.OnTalkToFollower += proc { |pkmn, random_val|
  if random_val == 0
    ...
    when 3, 9
      pbMoveRoute($game_player, [PBMoveRoute::Wait, 70])
...
Events.OnTalkToFollower += proc { |pkmn, random_val|
  if random_val == 1
    ...
    case value
    when 6, 7, 8
      pbMoveRoute($game_player, [PBMoveRoute::Wait, 30])
      FollowingPkmn.move_route([
        PBMoveRoute::Jump, 0, 0,
        PBMoveRoute::Wait, 10,
        PBMoveRoute::Jump, 0, 0
