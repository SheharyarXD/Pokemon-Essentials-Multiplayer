  ...
  def initialize
    ...
    @treasure = {
      "Common"    => [:EXPCANDYXS,:EXPCANDYS,:MAXHONEY,
                      ...
                      :LEAFSTONE,:FIRESTONE,:WATERSTONE,:EVERSTONE,:HPUP,:PROTEIN,:IRON,:CALCIUM,:ZINC,:CARBOS,
                     ],
...
:POWERWEIGHT,:POWERBRACER,:POWERBELT,:POWERLENS,:POWERBAND,:POWERANKLET,
                      :MOONSTONE,:SUNSTONE,:THUNDERSTONE,:ICESTONE,:DUSKSTONE,:DAWNSTONE,:SHINYSTONE,
                     ],  
      "Rare"      => [:EXPCANDYL,:EXPCANDYXL,:MAXEGGS,:MAXCRYSTAL,:RARECANDY,:MAXSCALES,:MAXPLUMAGE,
                      :BALMMUSHROOM,:RELICBAND,:RELICSTATUE,
                      :IVHPUP,:IVPROTEIN,:IVIRON,:IVCALCIUM,:IVZINC,:IVCARBOS,
                      :PPUP,:ABILITYCAPSULE,:BIGNUGGET,:PEARLSTRING,
                      :KINGSROCK
                     ],
      "Very Rare" => [:DYNAMAXCANDYXL,:MAXSOUP,
                      :RELICCROWN,:PPMAX,
                      :VENUSAURITE,:CHARIZARDITEX,:CHARIZARDITEY,:BLASTOISINITE,
:ALAKAZITE,:SALAMENCITE,:GARDEVOIRITE,
:MEWTWONITEX,:MEWTWONITEY,
:SCEPTILITE,:BLAZIKENITE,
:SHARPEDONITE,:CAMERUPTITE,
:METAGROSSITE,:GALLADITE,
