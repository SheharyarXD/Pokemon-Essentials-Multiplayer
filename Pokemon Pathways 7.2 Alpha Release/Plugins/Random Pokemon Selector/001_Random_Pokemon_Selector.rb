...
def getLegendOrMythic
  ...
  :DARKRAI, :SHAYMIN, :ARCEUS, :URSALUNA, :WYRDEER, :BASCULEGION, :CLODSIRE,
  :VICTINI, :KELDEO, :MELOETTA, :GENESECT, :IRONLEAVES, :FARIGIRAF, :KINGGAMBIT, :ANNIHILAPE, :MEOWSCARADA, :FLORAGATO, :BAXCALIBUR, :ARCTIBAX,
  :DIANCIE, :HOOPA, :VOLCANION, :MEGARAYQUAZA, :MIRAIDON, :KORAIDON, :CERULEDGE, :ARMAROUGE, :SNEASLER, :QUAQUAVAL, :QUAXWELL, :SKELEDIRGE, :CROCALOR,
  :MAGEARNA, :MARSHADOW, :ZERAORA, :IRONVALIANT, :IRONTREADS, :IRONBUNDLE, :IRONHANDS, :IRONJUGULIS, :IRONMOTH, :IRONHORNS, :ENAMORUS, :WALKINGWAKE, :DUDUNSPARCE,
  :MELTAN, :MELMETAL, :ZARUDE, :GREATTUSK, :SCREAMTAIL, :BRUTEBONNET, :FLUTTERMANE, :SLITHERWING, :GREATTUSK, :SANDYSHOCKS, :WOCHIEN, :CHIENPAO, :TINGLU, :CHIYU, :ROARINGMOON]
  return arr
end
